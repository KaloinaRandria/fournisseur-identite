 ...
 */
final class Version20241218120637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE jeton (id INT NOT NULL, jeton TEXT NOT NULL, default_duree_jeton INT NOT NULL, expiration_util_date_insertion TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expiration_util_date_expiration TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expiration_util_duree DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE semester (id INT NOT NULL, label VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
